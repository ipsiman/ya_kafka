...
if __name__ == '__main__':
    ...
    print("Начинаем потребление сообщений из topic-1...")
    try:
        while True:
            ...
            print(
                f'Получено сообщение: key={key}, value={value}, topic={message.topic()}, partition={message.partition()}, offset={message.offset()}')
